...
flowchart LR
   ...
   A[Lighting Console] -- LAN --> B[Gigacore 26i-POE]
   B -- LAN --> C[Gigacore 14K-POE]
   C -- LAN --> D[Protocol Convertor]
   D -- LAN --> E[Dimmer Rack]
   B -- LAN --> F[Protocol Convertor]
   B -- LAN --> G[Protocol Convertor]
   B -- LAN --> H[Protocol Convertor]
   B -- LAN --> I[Protocol Convertor]
   B -- LAN --> J[Protocol Convertor]
   B -- LAN --> K[Protocol Convertor]
